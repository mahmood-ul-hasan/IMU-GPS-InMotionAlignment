...
% paper named "Velocity/Position Integration Formula Part I: Application to
% In-Flight Coarse Alignment" published in IEEE TRANSACTIONS ON AEROSPACE AND
% ELECTRONIC SYSTEMS VOL. 49, NO. 2 APRIL 2013
...
% Vn0=data_imu(strtTime_imu-1+99,11:13) ;end
...
figure, plot(TimeAxisGPS,timeAttitude,'LineWidth',2), title('Error in degree'); grid on, xlabel('Time /s'); ylabel('Error using quat in degree'),legend('Roll','Pitch','yaw'), %axis([0,t*nn_gps,-0.05,0.05])
